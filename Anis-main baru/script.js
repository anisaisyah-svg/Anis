...
function lightmode(){
   ...
   document.getElementById("first-page").style.backgroundColor="#ADD8E6";
}
...
function welc(){
   document.getElementById("welcome").style.backgroundColor="#ffffed";} 
   
function borang(){
   document.getElementById("form").style.backgroundColor="#ffe4e1";}   